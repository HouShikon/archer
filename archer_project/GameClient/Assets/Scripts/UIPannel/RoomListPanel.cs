...
public class RoomListPanel : BasePanel
{
    ...
    private void Start()
    {
        ...
        transform.Find("RoomList/CreateRoom").GetComponent<Button>().onClick.AddListener(OnCreateRoomClick);
        transform.Find("RoomList/RefreshRoom").GetComponent<Button>().onClick.AddListener(OnRefreshClick);
    ...
    private void SetBattleRes()
    {
        ...
        transform.Find("BattleRes/Total").GetComponent<Text>().text = "总场数:" + ud.TotalCount.ToString();
        transform.Find("BattleRes/Win").GetComponent<Text>().text = "胜利:" + ud.WinCount.ToString();
    }
