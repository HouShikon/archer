...
public class RoomPanel : BasePanel
{
    ...
    private void Start()
    {
        localPlayerUsername = transform.Find("BluePanel/Name").GetComponent<Text>();
        localPlayerTotalCount = transform.Find("BluePanel/Total").GetComponent<Text>();
        localPlayerWinCount = transform.Find("BluePanel/Win").GetComponent<Text>();
        enemyPlayerUsername = transform.Find("RedPanel/Name").GetComponent<Text>();
        enemyPlayerTotalCount = transform.Find("RedPanel/Total").GetComponent<Text>();
        enemyPlayerWinCount = transform.Find("RedPanel/Win").GetComponent<Text>();

        bluePanel = transform.Find("BluePanel");
        redPanel = transform.Find("RedPanel");
        startButton = transform.Find("StartButton");
        exitButton = transform.Find("QuitButton");

        


        transform.Find("StartButton").GetComponent<Button>().onClick.AddListener(OnStartClick);
        transform.Find("QuitButton").GetComponent<Button>().onClick.AddListener(OnExitClick);
